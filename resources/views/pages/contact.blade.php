...
@section('content')
    ...
    <header class="page-hero pb-5">
        <div class="page-hero__bg" data-bg="{{ asset('assets/images/gallery-02.jpg') }}" aria-hidden="true"></div>
                ...
                <div class="col-lg-5">
                    <div class="d-flex gap-3 pb-4 mb-4 border-bottom" style="border-color:rgba(255,255,255,.1)">
                        ...
                        <div>
                            ...
                            <div class="ff-display fs-4 text-white"><a href="tel:(303) 915-3703" class="text-white">(303)
                                    915-3703</a>
                            </div>
