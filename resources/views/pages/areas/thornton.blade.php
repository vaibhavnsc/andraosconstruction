...
<main>
    ...
    <header class="page-hero">
        <div class="page-hero__bg" data-bg="/assets/images/thorn.jpg"
            aria-hidden="true"></div>
        <div class="page-hero__scrim" aria-hidden="true"></div>
        <div class="container">
            <nav class="breadcrumb-mono mb-3" aria-label="Breadcrumb">
                <a href="/">Home</a> &nbsp;/&nbsp;
                <a href="/service-areas">Service Areas</a> &nbsp;/&nbsp; Thornton
            </nav>
            <h1>Commercial Concrete Contractor in Thornton, Colorado</h1>
        </div>
    </header>
    ...
    <section class="section" aria-labelledby="intro-heading">
        <div class="container">
            <div class="row g-5 align-items-center reveal">
                <div class="col-lg-6">
                    <img height="auto" width="auto" src="/assets/images/thorn.jpg"
                        alt="Commercial concrete and asphalt work in Thornton, Colorado" class="ratio-4-3 img-treat">
                </div>
                <div class="col-lg-6">
                    <p class="eyebrow">Service Area &middot; Adams County</p>
                    <h2 id="intro-heading" class="ff-display display-md mt-2">
                        Commercial Concrete, Asphalt &amp; Masonry in Thornton
                    </h2>
                    <p class="lede mt-3">Thornton property managers, retail developers, and HOA communities engage
    ...
    <section class="section bg-warm section--tight" aria-labelledby="city-services-heading">
        <div class="container">
            <p class="eyebrow mb-2">Commercial Services in Thornton</p>
            <h2 id="city-services-heading" class="ff-display display-md mb-4">What We Build in Thornton, Colorado</h2>
            <div class="row g-3">
