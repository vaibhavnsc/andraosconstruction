    ...
    <section class="section" aria-labelledby="intro-heading">
      <div class="container">
        <div class="row g-5 align-items-center reveal">
          <div class="col-lg-6">
            <img height="auto" width="auto" src="{{ asset('assets/images/andraos-construction43.jpeg') }}"
          ...
          <div class="col-lg-6">
            ...
            <div class="d-flex gap-2 mt-4 flex-wrap">
              <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Aurora</a>
    ...
    <section class="section section--tight" aria-labelledby="why-city-heading">
      <div class="container">
        <div class="row g-5">
          ...
          <li>Retail Commercial Concrete in Aurora</li>
