...
@php
    ...
    $title = $seo->meta_title ?? 'Concrete & Asphalt Contractor Broomfield, CO
';

    $description = $seo->meta_description
        ?? 'Commercial concrete, asphalt, masonry & snow-melt in Broomfield & the north metro since 1993. Call or text (303) 915-3703.';
@endphp
...
<main>
    ...
    <header class="page-hero">
        ...
        <div class="container">
            <nav class="breadcrumb-mono mb-3" aria-label="Breadcrumb">
                <a href="/">Home</a> &nbsp;/&nbsp;
                <a href="/service-areas">Service Areas</a> &nbsp;/&nbsp; Broomfield
            </nav>
            <h1>Broomfield Commercial Concrete Contractor</h1>
        </div>
    </header>
    ...
    <section class="section" aria-labelledby="intro-heading">
        <div class="container">
            <div class="row g-5 align-items-center reveal">
                <div class="col-lg-6">
                    <img height="auto" width="auto" src="/assets/images/zolo.jpg"
                        alt="Commercial concrete and asphalt work in Broomfield, Colorado" class="ratio-4-3 img-treat">
                </div>
                <div class="col-lg-6">
                    <p class="eyebrow">Service Area &middot; Broomfield County</p>
                    <h2 id="intro-heading" class="ff-display display-md mt-2">
                        Commercial Concrete, Asphalt &amp; Masonry in Broomfield
                    </h2>
                    <p class="lede mt-3">Andraos Construction provides commercial concrete, asphalt, and masonry
                        services across Broomfield's mixed-use developments, office parks, and HOA communities &mdash;
                        full-scope capital renewal and tenant improvement support.</p>
                    <div class="d-flex gap-2 mt-4 flex-wrap">
                        <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Broomfield</a>
    ...
    <section class="section bg-warm section--tight" aria-labelledby="city-services-heading">
        <div class="container">
            <p class="eyebrow mb-2">Commercial Services in Broomfield</p>
            <h2 id="city-services-heading" class="ff-display display-md mb-4">What We Build in Broomfield, Colorado</h2>
            <div class="row g-3">
    ...
    <section class="section section--tight" aria-labelledby="why-city-heading">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4">
                    <p class="eyebrow mb-2">Why Broomfield Chooses Andraos</p>
                    ...
                    <p class="text-slate mt-3">
                        ...
                        across Broomfield County. One project manager owns your job from estimate to warranty &mdash;
                        backed
                ...
                <div class="col-lg-8">
                    <ul class="location-services">
                        <li>Commercial Concrete in Broomfield</li>
    ...
    <section class="section bg-navy text-white section--tight" aria-labelledby="nearby-heading">
        <div class="container">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <a href="/service-areas/boulder" class="area-card">
                        <span>
                ...
                <div class="col-md-4">
                    <a href="/service-areas/thornton" class="area-card">
                        <span>
