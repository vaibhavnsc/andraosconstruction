...
<main>
    ...
    <header class="page-hero">
      <div class="page-hero__bg" data-bg="/assets/images/hoa.jpg" aria-hidden="true"></div>
    ...
    <section class="section" aria-labelledby="intro-heading">
      <div class="container">
        <div class="row g-5 align-items-center reveal">
          <div class="col-lg-6">
            <img height="auto" width="auto" src="{{ asset('assets/images/hoa.jpg') }}"
                 alt="Commercial concrete and asphalt work in Littleton, Colorado"
                 class="ratio-4-3 img-treat">
          </div>
          <div class="col-lg-6">
            <p class="eyebrow">Service Area &middot; Jefferson &amp; Arapahoe Counties</p>
            <h2 id="intro-heading" class="ff-display display-md mt-2">
              Commercial Concrete, Asphalt &amp; Masonry in Littleton
            </h2>
            <p class="lede mt-3">Andraos Construction provides commercial concrete services to Littleton property managers, retail centers, and HOA communities throughout Jefferson and Arapahoe Counties &mdash; capital renewal programs, ADA flatwork, parking lot resurfacing, and snow-melt integration.</p>
            <div class="d-flex gap-2 mt-4 flex-wrap">
              <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Littleton</a>
    ...
    <section class="section bg-warm section--tight" aria-labelledby="city-services-heading">
      <div class="container">
        <p class="eyebrow mb-2">Commercial Services in Littleton</p>
        <h2 id="city-services-heading" class="ff-display display-md mb-4">What We Build in Littleton, Colorado</h2>
        <div class="row g-3">
    ...
    <section class="section bg-navy-deep text-white text-center" aria-labelledby="city-cta-heading">
      <div class="container reveal">
        <h2 id="city-cta-heading" class="ff-display display-xl text-white mx-auto maxw-20">Get a quote for your Littleton project.</h2>
