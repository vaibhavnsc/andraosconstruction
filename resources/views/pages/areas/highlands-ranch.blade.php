...
@php
    ...
    $title = $seo->meta_title ?? 'Concrete & Asphalt Contractor Highlands Ranch, CO';

    $description = $seo->meta_description
        ?? 'Commercial concrete, asphalt, masonry & snow-melt in Highlands Ranch & Douglas County since 1993. Call (303) 915-3703.';
@endphp
    ...
    <section class="section" aria-labelledby="intro-heading">
        <div class="container">
            <div class="row g-5 align-items-center reveal">
                <div class="col-lg-6">
                    <img height="auto" width="auto" src="{{ asset('assets/images/hoa-multifamily.jpg') }}"
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-2 mt-4 flex-wrap">
                        <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Highlands Ranch</a>
