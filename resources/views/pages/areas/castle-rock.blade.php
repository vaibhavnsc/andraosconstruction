...
@php
    ...
    $title = $seo->meta_title ?? 'Concrete & Asphalt Contractor Castle Rock, CO';

    $description = $seo->meta_description
        ?? 'Commercial concrete, asphalt, masonry & snow-melt in Castle Rock & Douglas County since 1993. Request an Estimate: (303) 915-3703.';
@endphp
...
@section('content')
  ...
  <main>
    ...
    <header class="page-hero">
      <div class="page-hero__bg" data-bg="/assets/images/snow.jpg" aria-hidden="true"></div>
        ...
        <div class="row g-5 align-items-center reveal">
          ...
          <div class="col-lg-6">
            ...
            <h2 id="intro-heading" class="ff-display display-md mt-2">
              Commercial Concrete, Asphalt &amp; Masonry in Castle Rock
            </h2>
            ...
            <div class="d-flex gap-2 mt-4 flex-wrap">
              <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Castle Rock</a>
    ...
    <section class="section bg-warm section--tight" aria-labelledby="city-services-heading">
      <div class="container">
        <p class="eyebrow mb-2">Commercial Services in Castle Rock</p>
        <h2 id="city-services-heading" class="ff-display display-md mb-4">What We Build in Castle Rock, Colorado</h2>
        <div class="row g-3">
    ...
    <section class="section section--tight" aria-labelledby="why-city-heading">
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-4">
            <p class="eyebrow mb-2">Why Castle Rock Chooses Andraos</p>
          ...
          <li>Commercial Concrete in Castle Rock</li>
    ...
    <section class="section bg-navy-deep text-white text-center" aria-labelledby="city-cta-heading">
      <div class="container reveal">
        <h2 id="city-cta-heading" class="ff-display display-xl text-white mx-auto maxw-20">Get a quote for your Castle Rock project.</h2>
