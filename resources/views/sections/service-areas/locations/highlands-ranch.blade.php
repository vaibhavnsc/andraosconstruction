...
<main>
    ...
    <header class="page-hero">
        <div class="page-hero__bg" data-bg="../assets/images/andraos-construction-gallery-040-665h.jpg"
            ...
            <div class="row g-5 align-items-center reveal">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-2 mt-4 flex-wrap">
                        <a href="../contact.html" class="btn btn-navy btn-arrow">Request a Quote in Highlands Ranch</a>
