<section class="section bg-navy text-white" aria-label="Project gallery">
    <div class="container">
        ...
        <div class="row g-3" id="projGrid">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0015.jpeg') }}"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0026.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0051.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0069.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_3620.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0067.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/IMG_0068.jpeg') }}"
                        alt="Commercial Concrete">
                    <figcaption class="ov"><span class="cat">commercial-concrete</span><span class="nm">Whole Foods</span><span class="small text-white-50">Commercial Concrete</span></figcaption>
                </figure>
            </div>
