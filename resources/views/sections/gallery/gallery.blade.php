<section class="section bg-navy text-white" aria-label="Project gallery">
    <div class="container">
        ...
        <div class="row g-3" id="projGrid">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/andraos-construction43.jpeg') }}"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/hoa-andros.webp') }}"
                        alt="Logan Reserve Drives — Aurora · 14 drive lanes">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/andraos-construction.webp') }}"
                        alt="Logan Reserve Drives — Aurora · 14 drive lanes">
                    <figcaption class="ov"><span class="cat">hoa</span><span class="nm">HOA</span><span class="small text-white-50">HOA</span>
                    </figcaption>
                </figure>
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/stucco/IMG_0669.jpg') }}" alt="Stucco">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/stucco/IMG_3656.jpeg') }}" alt="Stucco">
                    <figcaption class="ov"><span class="cat">stucco</span><span class="nm">Stucco</span><span
                            class="small text-white-50">Stucco</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/schomp-ford-aurora.png') }}"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/cherry-creek.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/1075-Park-Ave-Denver.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/advanced-energy-fort-collins.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/blackhawk.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/blake-street.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/central-park-highlands.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/chick-fil-a.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/denver-sidewalks.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/tommys.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/whole-foods-lakewood.jpg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/town-center.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/commercial/wildcat-reserve-highlands.jpeg') }}"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_0041.jpeg') }}"
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_0054.jpeg') }}"
                        alt="Residential Concrete">
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_0061.jpeg') }}"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_0079.jpeg') }}"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_5912.jpeg') }}"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_7038.jpeg') }}"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential/IMG_0161.jpg') }}"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/168-25.jpg') }}" alt="Asphalt">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/168-25-Meadow.jpg') }}"
                        alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/HOA_Littleton_IMG_3636.jpeg') }}"
                        alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/IMG_3635.jpeg') }}" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/Songbird_HOA_IMG_3637.jpeg') }}" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/asphalt/Songbird_HOA_Littleton_IMG_3638.jpeg') }}" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25f.jpeg') }}" alt="Snow Melt Systems">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25s.jpeg') }}" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25si.jpeg') }}" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25t.jpeg') }}" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25th.jpeg') }}" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/snowmelt/064-25fi.jpg') }}" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/concrete-finishes/Colored-concrete.jpeg') }}" alt="Concrete Finishes">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/concrete-finishes/Exposed-aggregate.jpg') }}" alt="Exposed Aggregate">
                    <figcaption class="ov"><span class="cat">concrete-finishes</span><span class="nm">Exposed Aggregate</span><span
                            class="small text-white-50">Concrete Finishes</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/concrete-finishes/Stamped-concrete.JPG') }}" alt="Concrete Finishes">
                    <figcaption class="ov"><span class="cat">concrete-finishes</span><span class="nm">Stamped Concrete</span><span
                            class="small text-white-50">Concrete Finishes</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/masonry/IMG_1450.jpg') }}" alt="Commercial Masonry Before/After">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/masonry/IMG_0038.jpeg') }}" alt="Commercial Masonry Before/After">
                    <figcaption class="ov"><span class="cat">masonry</span><span class="nm">DTC Masonry Project </span><span
                            class="small text-white-50">Masonry</span></figcaption>
                </figure>
            </div>
            <!-- <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Acid_stained_patio.jpeg') }}" alt="Acid Stained Patio">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Classical_gray_colored_patio_with_steps.jpeg') }}" alt="Classical Gray Colored Patio with Steps">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Colored_concrete_patio.jpeg') }}" alt="Colored Concrete Patio">
                    <figcaption class="ov"><span class="cat">residential-concrete</span><span class="nm">Colored Concrete Patio</span><span
                            class="small text-white-50">Residential Patio</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Colored_stamped_patio.jpeg') }}" alt="Colored Stamped Patio">
                    <figcaption class="ov"><span class="cat">residential-concrete</span><span class="nm">Colored Stamped Patio</span><span
                            class="small text-white-50">Residential Patio</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Concrete_and_masonry_patio.jpeg') }}" alt="Concrete and Masonry Patio">
                    <figcaption class="ov"><span class="cat">residential-concrete</span><span class="nm">Concrete and Masonry Patio</span><span
                            class="small text-white-50">Residential Patio</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Exposed_aggregate_patio.jpeg') }}" alt="Exposed Aggregate Patio">
                    <figcaption class="ov"><span class="cat">residential-concrete</span><span class="nm">Exposed Aggregate Patio</span><span
                            class="small text-white-50">Residential Patio</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/Gray_patio_with_steps.jpeg') }}" alt="Gray Patio with Steps">
                    <figcaption class="ov"><span class="cat">residential-concrete</span><span class="nm">Gray Patio with Steps</span><span
                            class="small text-white-50">Residential Patio</span></figcaption>
                </figure>
            </div>
             <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/before-Jones-residence.jpeg') }}" alt="Before Jones Residence">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="{{ asset('assets/images/residential-concrete/after-Jones-residence.jpeg') }}" alt="After Jones Residence">
