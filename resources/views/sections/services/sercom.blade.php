<section class="section" aria-label="Service details">
    <div class="container" id="js-service-detail">
        <div class="row g-5 align-items-center reveal anchor-offset is-visible" id="commercial-concrete">
            <div class="col-lg-6"><img src="{{ asset('assets/images/commercial.jpg') }}"
                    alt="Commercial Concrete" class="ratio-4-3 img-treat"></div>
            <div class="col-lg-6"><span class="num-eyebrow">01 / 06</span>
                ...
                <div class="d-flex flex-wrap gap-1 mt-3"><span class="tag">Flatwork</span><span class="tag">Curb &amp;
                        gutter</span><span class="tag">ADA</span></div><a href="{{ route('contact') }}"
        ...
        <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible" id="asphalt">
            ...
            <div class="col-lg-6 order-lg-1"><span class="num-eyebrow">02 / 06</span>
                ...
                <div class="d-flex flex-wrap gap-1 mt-3"><span class="tag">Mill &amp; overlay</span><span
                        class="tag">Sealcoat</span><span class="tag">Striping</span></div><a href="{{ route('contact') }}"
                    class="btn btn-outline-navy btn-arrow mt-4">Request a Quote</a>
            </div>
        </div>
        <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible" id="masonry">
            <div class="col-lg-6"><img src="{{ asset('assets/images/masonry.jpg') }}"
                    alt="Commercial Masonry" class="ratio-4-3 img-treat"></div>
            <div class="col-lg-6"><span class="num-eyebrow">03 / 06</span>
                ...
                <div class="d-flex flex-wrap gap-1 mt-3"><span class="tag">Sandstone</span><span
                        class="tag">Brick</span><span class="tag">Retaining walls</span></div><a href="{{ route('contact') }}"
                    class="btn btn-outline-navy btn-arrow mt-4">Request a Quote</a>
            </div>
        </div>
        <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible" id="snow-melt">
            <div class="col-lg-6 order-lg-2"><img src="{{ asset('assets/images/snow.jpg') }}"
                    alt="Snow Melt Systems" class="ratio-4-3 img-treat"></div>
            <div class="col-lg-6 order-lg-1"><span class="num-eyebrow">04 / 06</span>
                ...
                <div class="d-flex flex-wrap gap-1 mt-3"><span class="tag">Hydronic</span><span
                        class="tag">Entries</span><span class="tag">ADA ramps</span></div><a href="{{ route('contact') }}"
                    class="btn btn-outline-navy btn-arrow mt-4">Request a Quote</a>
            </div>
        </div>
        <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible"
            id="hoa-property-management">
            <div class="col-lg-6"><img src="{{ asset('assets/images/hoa.jpg') }}"
            ...
            <div class="col-lg-6"><span class="num-eyebrow">05 / 06</span>
                ...
                <div class="d-flex flex-wrap gap-1 mt-3"><span class="tag">Capital renewal</span><span
                        class="tag">Sidewalks</span><span class="tag">Repair</span></div><a href="{{ route('contact') }}"
                    class="btn btn-outline-navy btn-arrow mt-4">Request a Quote</a>
            </div>
        </div>
        <!-- <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible"
            ...
            <div class="col-lg-6 order-lg-1"><span class="num-eyebrow">06 / 06</span>
