...
<header class="page-hero">
    <div class="page-hero__bg" id="js-service-hero-bg" aria-hidden="true" data-bg="/assets/images/hoa.jpg"
            ...
            <div class="col-lg-8">
                <article class="reveal is-visible">
                    <img id="js-service-image" alt="HOA &amp; Property Management" class="ratio-16-9 mb-4"
                        src="/assets/images/hoa.jpg">

                    <p class="eyebrow">Overview</p>
                    <h2 class="ff-display display-md mt-2 mb-3">
                        Commercial-Grade Work, Self-Performed
                    </h2>
                    <p class="lede" id="js-service-overview">We partner with HOA boards and property management
                        companies on multi-phase capital renewal, sequenced around residents and tenants. One project
                        manager owns the program end to end — sidewalks, drive lanes, curb &amp; gutter, parking lots,
                        and asphalt maintenance — with a written one-year workmanship warranty.</p>
