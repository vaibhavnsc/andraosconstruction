...
<header class="page-hero">
    <div class="page-hero__bg" id="js-service-hero-bg" aria-hidden="true"
        data-bg="/assets/images/sloan.jpg"
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            <article class="reveal is-visible">
              <img id="js-service-image" alt="Asphalt Paving &amp; Repair" class="ratio-16-9 mb-4" src="/assets/images/sloan.jpg">

              <p class="eyebrow">Overview</p>
              <h2 class="ff-display display-md mt-2 mb-3">
                Commercial-Grade Work, Self-Performed
              </h2>
              <p class="lede" id="js-service-overview">Our asphalt division handles everything from routine maintenance to full-depth reconstruction. We help property managers and HOAs extend pavement life with the right treatment at the right time — crackfilling and sealcoating early, mill &amp; overlay at mid-life, and full-depth replacement when the base has failed.</p>

              <div class="d-flex flex-wrap gap-1 mt-3" id="js-service-tags"><span class="tag">Mill &amp; overlay</span><span class="tag">Sealcoat</span><span class="tag">Striping</span></div>

              <!-- What's included -->
              <h2 class="ff-display display-md mt-5 mb-4">What’s Included</h2>
              <ul class="included-list row row-cols-1 row-cols-md-2 g-0" id="js-service-included"><li>Asphalt mill &amp; overlay</li><li>Full-depth removal &amp; replacement</li><li>Crackfilling &amp; sealcoating</li><li>Pothole &amp; patch repair</li><li>Striping &amp; pavement marking</li><li>Parking lot maintenance programs</li></ul>
          ...
          <aside class="col-lg-4" aria-label="Service navigation">
            <div class="sidebar-card">
              ...
              <nav id="js-service-nav"><a class="service-nav-link" href="service-detail.html?service=commercial-concrete">Commercial Concrete<span aria-hidden="true">→</span></a><a class="service-nav-link active" href="service-detail.html?service=asphalt">Asphalt Paving &amp; Repair<span aria-hidden="true">→</span></a><a class="service-nav-link" href="service-detail.html?service=masonry">Commercial Masonry<span aria-hidden="true">→</span></a><a class="service-nav-link" href="service-detail.html?service=snow-melt">Snow Melt Systems<span aria-hidden="true">→</span></a><a class="service-nav-link" href="service-detail.html?service=hoa-property-management">HOA &amp; Property Management<span aria-hidden="true">→</span></a><a class="service-nav-link" href="service-detail.html?service=concrete-finishes">Concrete Finishes<span aria-hidden="true">→</span></a></nav>
            </div>
