...
<section class="section bg-navy text-white" aria-label="Project gallery">
    <div class="container">
        ...
        <div class="row g-3" id="projGrid">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/168-25.jpg')); ?>" alt="Asphalt">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/IMG_3635.jpeg')); ?>" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/Songbird_HOA_IMG_3637.jpeg')); ?>" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/Songbird_HOA_Littleton_IMG_3638.jpeg')); ?>" alt="Asphalt">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Asphalt</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
