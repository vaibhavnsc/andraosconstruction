...
<!-- ====================== PAGE HERO ====================== -->
    <header class="page-hero">
      <div class="page-hero__bg" data-bg="<?php echo e(asset('assets/images/andraos-construction-gallery.jpg')); ?>" aria-hidden="true"></div>
    ...
    <div class="container">
        ...
        <div class="row g-3" id="projGrid">
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction37.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction43.jpeg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/hoa-andros.webp')); ?>"
                        alt="Logan Reserve Drives — Aurora · 14 drive lanes">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction.webp')); ?>"
                        alt="Logan Reserve Drives — Aurora · 14 drive lanes">
                    <figcaption class="ov"><span class="cat">hoa</span><span class="nm">HOA</span><span class="small text-white-50">HOA</span>
                    </figcaption>
                </figure>
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/stucco/IMG_0669.jpg')); ?>" alt="Stucco">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/stucco/IMG_3656.jpeg')); ?>" alt="Stucco">
                    <figcaption class="ov"><span class="cat">stucco</span><span class="nm">Stucco</span><span
                            class="small text-white-50">Stucco</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/schomp-ford-aurora.png')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/cherry-creek.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/1075-Park-Ave-Denver.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/advanced-energy-fort-collins.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/blackhawk.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/blake-street.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/central-park-highlands.jpeg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/chick-fil-a.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/denver-sidewalks.jpeg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/tommys.jpeg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/whole-foods-lakewood.jpg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/town-center.jpeg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/commercial/wildcat-reserve-highlands.jpeg')); ?>"
                        alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_0041.jpeg')); ?>"
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_0054.jpeg')); ?>"
                        alt="Residential Concrete">
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_0061.jpeg')); ?>"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_0079.jpeg')); ?>"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_5912.jpeg')); ?>"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_7038.jpeg')); ?>"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/residential/IMG_0161.jpg')); ?>"
                        alt="Residential Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/168-25-Meadow.jpg')); ?>"
                        alt="Meadow Wood">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/168-25.jpg')); ?>" alt="Meadow Wood 2">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Meadow Wood 2</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/HOA_Littleton_IMG_3636.jpeg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/IMG_3635.jpeg')); ?>" alt="Songbird HOA Littleton">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Songbird HOA Littleton</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/Songbird_HOA_IMG_3637.jpeg')); ?>" alt="Songbird HOA Littleton">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Songbird HOA Littleton</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/asphalt/Songbird_HOA_Littleton_IMG_3638.jpeg')); ?>" alt="Songbird HOA Littleton">
                    <figcaption class="ov"><span class="cat">asphalt</span><span class="nm">Songbird HOA Littleton</span><span
                            class="small text-white-50">Asphalt</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25f.jpeg')); ?>" alt="Snow Melt Systems">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25s.jpeg')); ?>" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25si.jpeg')); ?>" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25t.jpeg')); ?>" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25th.jpeg')); ?>" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/snowmelt/064-25fi.jpg')); ?>" alt="Snow Melt Systems">
                    <figcaption class="ov"><span class="cat">snow-melt-system</span><span class="nm">Snow Melt Systems</span><span
                            class="small text-white-50">Snow Melt Systems</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/concrete-finishes/Colored-concrete.jpeg')); ?>" alt="Concrete Finishes">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/concrete-finishes/Exposed-aggregate.jpg')); ?>" alt="Exposed Aggregate">
                    <figcaption class="ov"><span class="cat">concrete-finishes</span><span class="nm">Exposed Aggregate</span><span
                            class="small text-white-50">Concrete Finishes</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/concrete-finishes/Stamped-concrete.JPG')); ?>" alt="Concrete Finishes">
                    <figcaption class="ov"><span class="cat">concrete-finishes</span><span class="nm">Stamped Concrete</span><span
                            class="small text-white-50">Concrete Finishes</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/IMG_1450.jpg')); ?>" alt="Commercial Masonry Before/After">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/Blackhawk.jpeg')); ?>" alt="Blackhawk">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/IMG_0038.jpeg')); ?>" alt="Commercial Masonry Before/After">
                    <figcaption class="ov"><span class="cat">masonry</span><span class="nm">DTC Masonry Project </span><span
                            class="small text-white-50">Masonry</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/Cherry-Creek-Country.jpeg')); ?>" alt="Cherry Creek Country">
                    <figcaption class="ov"><span class="cat">masonry</span><span class="nm">Cherry Creek Country </span><span
                            class="small text-white-50">Masonry</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/Cherry-Creek-Country-Club.JPEG')); ?>" alt="Cherry Creek Country Club">
                    <figcaption class="ov"><span class="cat">masonry</span><span class="nm">Cherry Creek Country Club</span><span
                            class="small text-white-50">Masonry</span></figcaption>
                </figure>
            </div>
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/masonry/Masonry-Vasa.jpeg')); ?>" alt="Masonry Vasa">
