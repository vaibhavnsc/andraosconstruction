<?php
    ...
    $description =
        ...
        'Request an Commercial concrete, asphalt or masonry quote in Denver & the Front Range. Estimates in 3–5 days. Call or text (303) 915-3703.';
?>
        ...
        <div class="container">
            <div class="row g-5 mb-5 reveal">
                ...
                <div class="col-lg-6 d-flex align-items-end">
                    <p class="lede" style="color:var(--slate-300)">Quotes in 3–5 business days. Emergencies same-day. Call
                        us or
                ...
                <div class="col-lg-5">
                    <div class="d-flex gap-3 pb-4 mb-4 border-bottom" style="border-color:rgba(255,255,255,.1)">
                        ...
                        <div>
                            ...
                            <div class="ff-display fs-4 text-white"><a href="tel:+13039153703" class="text-white">(303)
                                    915-3703</a>
                            </div>
                            <div class="text-slate" style="font-size:13px;color:rgba(255,255,255,.6)!important">Mon–Fri ·
                                8am – 5pm ·
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            ...
                            <div style="font-size:13px;color:rgba(255,255,255,.6)">Bonded for commercial. Certificates on
                                request.</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="company" class="form-control"
                                        placeholder="Required for commercial">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="approx_size" class="form-control"
                                        placeholder="e.g. 12,000 SF">
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.validator.addMethod("phoneUS", function(value, element) {
                return this.optional(element) || /^[\d\s\-\(\)]+$/.test(value.trim()) && value.replace(
                    /\D/g, '').length >= 10;
                            ...
                            $.ajax({
                                ...
                                error: function(xhr) {
                                    ...
                                    if (xhr.status === 422) {
                                        ...
                                        let serverMsg = xhr.responseJSON?.message ||
                                            "Something went wrong. Please try again.";
                                        $("#errorMessage").text(serverMsg)
                                            .removeClass("d-none");
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH J:\andraosconstruction\andraosconstruction\resources\views/pages/contact.blade.php ENDPATH**/ ?>