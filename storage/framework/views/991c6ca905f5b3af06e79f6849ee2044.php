...
<header class="page-hero">
  <div class="page-hero__bg" data-bg="<?php echo e(asset('/assets/images/About.jpg')); ?>" aria-hidden="true"></div>
...
Ray serves in estimating and customer relationship. He loves his work and the people he works with.</p>
            ...
            <div class="col-md-6 col-lg-4">
                <figure class="team-card h-100 m-0">
                    <div class="team-card__monogram" aria-hidden="true"><img src="<?php echo e(asset('assets/images/masonry/Max.jpeg')); ?>" style="width: inherit;"></div>
                    <figcaption class="team-card__body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Andros\andraosconstruction\resources\views/pages/about.blade.php ENDPATH**/ ?>