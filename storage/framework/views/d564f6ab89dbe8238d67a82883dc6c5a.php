...
<section class="hero" id="home">
    <div id="heroSlides2" style="position:absolute; inset:0; overflow:hidden; z-index:0;">
        <video autoplay muted loop playsinline style="width:100%; height:100%; object-fit:cover;">
            <source src="<?php echo e(asset('/assets/images/video/andraos-video.mp4')); ?>" type="video/mp4">
        </video>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="row g-2">
                        <div class="col-md-4"><a href="/services#commercial-concrete" class="hero-quick"><img
                                    src="<?php echo e(asset('/assets/images/commercialcon.JPG')); ?>" alt="Services">
                                <div>
                        ...
                        <div class="col-md-4"><a href="/services#asphalt" class="hero-quick"><img
                                    src="<?php echo e(asset('assets/images/asphalt.jpg')); ?>" alt="Services">
                                <div>
                        ...
                        <div class="col-md-4"><a href="/services#masonry" class="hero-quick"><img
                                    src="<?php echo e(asset('assets/images/masonary.jpg')); ?>" alt="Services">
                                <div>
        ...
        <div class="row g-3 reveal is-visible" id="js-brand-grid">
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/Costco.png?hjfdjh')); ?>" alt="Costco" />
                    <!--<span class="brand-wordmark">Costco</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/GartProperties.png')); ?>" alt="GartProperties" />
                    <!--<span class="brand-wordmark">Gart Properties</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/SheaProperties.png')); ?>" alt="Shea Properties" />
                    <!--<span class="brand-wordmark">Shea Properties</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/Gayloard.png')); ?>" alt="Marriott" />
                    <!--<span class="brand-wordmark">Gaylord Hotel</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/Starbucks.png')); ?>" alt="Starbucks" />
                    <!--<span class="brand-wordmark">Starbucks</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/Southlands.png')); ?>" alt="Southlands Mall" />
                    <!--<span class="brand-wordmark">Southlands Mall</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/BallysBlackHawk.png')); ?>" alt="Ballys Black Hawk" />
                    <!--<span class="brand-wordmark">Ballys Black Hawk</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/VASA.png')); ?>" alt="VASA" />
                    <!--<span class="brand-wordmark">VASA</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/Pavilions.png')); ?>" alt="Denver Pavilions" />
                    <!--<span class="brand-wordmark">Denver Pavilions</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/TommyCarWash.png')); ?>" alt="Tommy's Car Wash" />
                    <!--<span class="brand-wordmark">Tommy's Car Wash</span>-->
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/SchompCarDealerships.png')); ?>"
            ...
            <div class="col-12 col-md-4 col-lg-3">
                <div class="brand-tile">
                    <img height="auto" width="auto" src="<?php echo e(asset('assets/images/WorkedWith/WholeFoods.png')); ?>" alt="Whole Foods" />
        ...
        <div class="row g-5 align-items-center reveal abt-main" style="justify-content: flex-start;align-item:start;">
            <div class="col-lg-8 abt-img">
                <figure class="position-relative m-0 and-abt">
                    <img src="<?php echo e(asset('assets/images/About.jpg')); ?>" alt="Andraos Construction team at the Denver office conference room" class="ratio-4-5 img-treat obj-pos-top"
...
<section class="section bg-navy text-white" id="services">
    <div class="container">
        ...
        <div class="row g-4" id="svcGrid">
            <div class="col-lg-4 col-md-6">
                <a href="./commercial-concrete-services" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="commercial-concrete"><img
                            src="<?php echo e(asset('assets/images/commercialcon.JPG')); ?>" alt="Commercial Concrete">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="./asphalt-services" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="asphalt"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/asphalt/Hero-Song.JPG')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <a href="./masonry-services" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="masonry"><img
                            src="<?php echo e(asset('assets/images/masonry/Cherry-Creek-Country-Club.JPEG')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <a href="./snow-melt-services" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="snow-melt"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/snowmelt/064-25f.jpeg')); ?>"
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(route('services')); ?>" class="btn btn-light-navy btn-arrow">View All Services</a>
        </div>
    </div>
</section>
...
<section class="section bg-navy text-white pt-0" aria-labelledby="gallery-heading">
    <div class="container">
        ...
        <div class="row g-3" id="projGrid" data-limit="4">
            <!-- <div class="col-lg-4 col-md-6">
                                                                                                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/andraos-construction37.jpg')); ?>"
            ...
            <!-- <div class="col-lg-4 col-md-6">
                                                                                                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/andraos-construction1.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/Ford.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/tommy.JPEG')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/stucco/IMG_0669.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/Hero-Denver.JPG')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/andraos-construction2.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/Central-Park.jpeg')); ?>"
            ...
            <!-- <div class="col-lg-4 col-md-6">
                                                                                                <figure class="proj m-0"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/andraos-construction8.jpg')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Andros\andraosconstruction\resources\views/pages/home.blade.php ENDPATH**/ ?>