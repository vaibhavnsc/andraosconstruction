...
<?php $__env->startSection('canonical_url', $canonical_url); ?>
<?php endif; ?>
    ...
    <section class="section" aria-label="Service details">
        <div class="container" id="js-service-detail">
            <div class="row g-5 align-items-center reveal anchor-offset is-visible" id="commercial-concrete">
                <div class="col-lg-6"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/commercialcon.JPG')); ?>" alt="Commercial Concrete"
            ...
            <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible"
                ...
                <div class="col-lg-6 order-lg-2"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/residential/IMG_0079.jpeg')); ?>"
            ...
            <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible" id="asphalt">
                <div class="col-lg-6 "><img height="auto" width="auto" src="<?php echo e(asset('assets/images/asphalt/Hero-Song.JPG')); ?>"
            ...
            <div class="row g-5 align-items-center reveal anchor-offset pt-5 mt-5 border-top is-visible" id="snow-melt">
                <div class="col-lg-6"><img height="auto" width="auto" src="<?php echo e(asset('assets/images/snowmelt/064-25f.jpeg')); ?>" alt="Snow Melt Systems"
                        class="ratio-4-3 img-treat"></div>
                <div class="col-lg-6">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\CRN\andraosconstruction\resources\views/pages/services.blade.php ENDPATH**/ ?>