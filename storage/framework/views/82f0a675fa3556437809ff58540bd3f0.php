...
<section class="hero" id="home">
  <div id="heroSlides2" style="position:absolute; inset:0; overflow:hidden; z-index:0;">
    ...
    >
        <source src="<?php echo e(asset('/assets/images/banner.mp4')); ?>" type="video/mp4">
    </video>
</div>
        ...
        <div class="row g-5 align-items-center reveal" style="justify-content: flex-start;align-item:start;">
          <div class="col-lg-6">
            <figure class="position-relative m-0 and-abt">
              <img src="<?php echo e(asset('assets/images/home-about.jpg')); ?>" class="ratio-4-5 img-treat obj-pos-top" style="object-fit:unset;height=100%;min-height :580px;width=100%; "/>
        ...
        <div class="row g-4" id="svcGrid">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="./services/masonry" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="masonry"><img src="<?php echo e(asset('assets/images/masonry/IMG_1450.jpg')); ?>"
            ...
            <!-- <div class="col-lg-4 col-md-6">
                <a href="./services#concrete-finishes" class="svc-card d-block text-decoration-none">
                    <div class="svc-card" id="concrete-finishes"><img src="<?php echo e(asset('assets/images/finish.jpg')); ?>"
...
<section class="section bg-navy text-white pt-0" aria-labelledby="gallery-heading">
    <div class="container">
        ...
        <div class="row g-3" id="projGrid" data-limit="4">
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction1.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction2.jpg')); ?>"
            ...
            <div class="col-lg-4 col-md-6">
                <figure class="proj m-0"><img src="<?php echo e(asset('assets/images/andraos-construction8.jpg')); ?>"
