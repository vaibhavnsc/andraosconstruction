<meta charset="utf-8">
    ...
    <title><?php echo $__env->yieldContent('meta_title', 'Andraos Construction'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', ''); ?>">

    <link rel="canonical" href="<?php echo $__env->yieldContent('canonical_url', request()->fullUrl()); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('assets/images/logon.ico')); ?>">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logon.ico')); ?>">
    ...
    <script src="<?php echo e(asset('assets/js/site.js')); ?>" defer></script><?php /**PATH J:\andraosconstruction\andraosconstruction\resources\views/partials/head.blade.php ENDPATH**/ ?>