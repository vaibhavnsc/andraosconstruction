...
<header class="page-hero">
    <div class="page-hero__bg" data-bg="<?php echo e(asset('assets/images/commercialcon.JPG')); ?>" aria-hidden="true">
    </div>
...
<!-- ====================== INTRO ====================== -->
    <section class="section" aria-labelledby="intro-heading">
      <div class="container">
        <div class="row g-5 align-items-center reveal">
          <div class="col-lg-6">
            <img height="auto" width="auto" src="<?php echo e(asset('assets/images/commercialcon.JPG')); ?>" 
                 alt="Commercial concrete and asphalt work in Denver, Colorado"
                 class="ratio-4-3 img-treat">
          </div>
          <div class="col-lg-6">
            <p class="eyebrow">Service Area &middot; City &amp; County of Denver</p>
            <h2 id="intro-heading" class="ff-display display-md mt-2">
              Commercial Concrete, Asphalt &amp; Masonry in Denver
            </h2>
            ...
            <div class="d-flex gap-2 mt-4 flex-wrap">
              <a href="/contact" class="btn btn-navy btn-arrow">Request an Estimate in Denver</a>
    ...
    <section class="section bg-warm section--tight" aria-labelledby="city-services-heading">
      <div class="container">
        <p class="eyebrow mb-2">Commercial Services in Denver</p>
        <h2 id="city-services-heading" class="ff-display display-md mb-4">What We Build in Denver, Colorado</h2>
        <div class="row g-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH J:\andraosconstruction\andraosconstruction\resources\views/pages/areas/denver.blade.php ENDPATH**/ ?>